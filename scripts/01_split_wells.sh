...
barcode=$3 # ATGGCT, ACACCT, ATGGCT
...
if [ ! -d "/${barcode}" ] && echo "Directory ${barcode} DOES NOT exist..."; then
	mkdir -p ${barcode}
	for file in ${somm}_${barcode}_R*.fq;
	do	
		mv ${somm}_${barcode}_R*.fq ${barcode}/.
	done
fi
